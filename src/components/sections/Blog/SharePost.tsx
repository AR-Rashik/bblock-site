const SharePost = () => {
  return (
    <>
      <div className="mt-12 flex flex-wrap gap-4 md:items-center md:justify-between md:gap-0">
        <ul className="flex items-center gap-6">
          <li>
            <p className="font-medium text-foreground">Share On:</p>
          </li>
          <li>
            <a href="#" aria-label="social link">
              <svg
                className="fill-muted-foreground transition-all duration-300 hover:fill-primary"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
