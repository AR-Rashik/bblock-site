...
import RelatedPost from "@/components/sections/Blog/RelatedPost";
        ...
        <div className="mx-auto w-full">
          <div className="flex flex-col-reverse gap-7 lg:flex-row xl:gap-12">
            <div className="md:w-1/2 lg:w-[32%]">
                ...
                >
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-border px-6 py-4 shadow-md focus:border-primary focus:outline-none "
                    />
                    ...
                    >
                      <svg
                        className="fill-foreground transition-all duration-300 hover:fill-primary "
                        width="21"
                        height="21"
                        viewBox="0 0 21 21"
                        fill="none"
              ...
              <div className="animate_top secondary mb-10  rounded-md border border-border bg-card p-9 shadow-md">
            ...
            <div className="lg:w-2/3">
              <div className="animate_top rounded-md border  border-border bg-card p-7 shadow-md md:p-10">
                ...
                <h2 className="2xl:text-sectiontitle2 mb-5 mt-12 text-3xl font-semibold text-foreground">
                  Kobe Steel plant that supplied
                </h2>

                <ul className="2xl:gap-7 mb-9 flex flex-wrap gap-5">
                  <li>
                    <span className="text-foreground">Author: </span> Jhon Doe
                  </li>
                  <li>
